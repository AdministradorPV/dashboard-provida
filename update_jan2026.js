...
const CATEGORY_MAP = {
  ...
  '03 - Repasse Prestadores Clinica Médica': 'REPASSE PRESTADORES CLINICA MEDICA',
  ...
  '08 - Despesas com Utilidades e Serviços': 'DESPESAS COM UTILIDADES E SERVICOS',
...
async function run() {
  try {
    ...
    for (const u of units) {
      console.log(`  ${u.name.padEnd(30)} ebitda: ${u.ebitda.toFixed(2).padStart(12)} | netProfit: ${u.netProfit.toFixed(2).padStart(12)}`);
    }
  } catch (err) {
