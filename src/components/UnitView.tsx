    ...
    <div className="view-container">
       ...
       <div className="kpi-grid">
        ...
        <KPICard 
          ...
          value={calculateContribution(selectedUnit.ebitda, data.consolidated.ebitda)} 
        ...
        <KPICard 
          label="Margem EBITDA" 
          value={((selectedUnit.ebitda / selectedUnit.revenue) * 100).toFixed(1) + '%'} 
          icon={Activity}
          color="#10b981"
        />
      </div>
      ...
      <div className="grid-2">
         ...
         <div className="glass-panel table-container full-width-mobile">
            ...
            <tbody>
                ...
                <td>Receita Bruta</td>
                <td>{formatCurrency(selectedUnit.revenue)}</td>
                <td>100%</td>
                </tr>
                ...
                <td>EBITDA</td>
                <td>{formatCurrency(selectedUnit.ebitda)}</td>
                <td>{((selectedUnit.ebitda / selectedUnit.revenue) * 100).toFixed(1)}%</td>
                </tr>
                <tr className="row-highlight">
                <td>Resultado Líquido</td>
                <td>{formatCurrency(selectedUnit.netProfit)}</td>
                <td>{((selectedUnit.netProfit / selectedUnit.revenue) * 100).toFixed(1)}%</td>
                </tr>
            </tbody>
            </table>
            </div>
         ...
         <div className="glass-panel chart-container full-width-mobile">
            ...
            <ResponsiveContainer width="100%" height="100%">
                <BarChart data={topExpenses} layout="vertical" margin={{ top: 5, right: 30, left: 40, bottom: 5 }}>
                    <CartesianGrid strokeDasharray="3 3" stroke="rgba(255,255,255,0.1)" horizontal={false} />
                    <XAxis type="number" hide />
                    <YAxis type="category" dataKey="name" width={120} tick={{fill: '#94a3b8', fontSize: 11}} interval={0} />
                    <Tooltip 
